...
static const char *fonts[] = {
    ...
    "BlexMono Nerd Font Regular:style:medium:size=19"};
...
static const char *taskman[] = {"xfce4-taskmanager", NULL};
...
static const char *const autostart[] = {"firefox", NULL, "xfce4-terminal", NULL,
                                        NULL};
